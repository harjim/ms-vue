<!--
 * @Author: your name
 * @Date: 2021-09-07 11:04:48
 * @LastEditors: zdf
 * @LastEditTime: 2021-11-19 17:49:42
 * @Description: 成果批量审核modal
 * @FilePath: \MS-VUE\src\views\customer\modules\AuditProgress\modules\BatchAuditResultModal.vue
-->
  ...
  data () {
    return {
      columns: [
        ...
        { title: 'RD标题', field: 'pname', headerAlign: 'center', align: 'center', minWidth: '120' },
