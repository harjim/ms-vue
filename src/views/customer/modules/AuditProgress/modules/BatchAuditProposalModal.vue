<!--
 * @Author: your name
 * @Date: 2021-09-07 10:35:29
 * @LastEditors: lzh
 * @LastEditTime: 2021-09-08 15:17:39
 * @Description: 提案批量审核modal
 * @FilePath: \MS-VUE\src\views\customer\modules\AuditProgress\modules\BatchAuditProposalModal.vue
-->
  ...
  data () {
    return {
      columns: [
        ...
        { title: '标题', field: 'title', headerAlign: 'center', align: 'center', minWidth: '120' },
