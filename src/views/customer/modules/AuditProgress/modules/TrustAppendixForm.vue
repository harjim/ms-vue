<!--
 * @Author: your name
 * @Date: 2021-09-13 11:13:59
 * @LastEditors: lzh
 * @LastEditTime: 2021-09-13 14:17:54
 * @Description: 委托资料
 * @FilePath: \MS-VUE\src\views\customer\modules\AuditProgress\modules\TrustAppendixForm.vue
-->
<template>
  <div>
    <vxe-table
      id="TrustAppendixForm"
      row-id="id"
      ref="table"
      size="small"
      :data="tableData"
    ...
    >
      ...
      <vxe-table-column field="stage" title="项目阶段" width="80" align="center" header-align="center"></vxe-table-column>
      ...
      <vxe-table-column field="remark" title="备注" width="120" align="center" header-align="center"></vxe-table-column>
    </vxe-table>
